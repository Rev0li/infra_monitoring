---
ticket: TICKET-06
title: Déploiement automatique en dev
status: todo          # todo → coded → tested → refactored → validated
branch: feat/ticket-06
updated: 2026-09-16
---

# TICKET-06 — Déploiement automatique en dev

## 🎯 Objectif
Étendre le pipeline pour déployer automatiquement l'appli pilote dans le namespace dev à chaque push, via manifests K8s ou chart Helm minimal.
